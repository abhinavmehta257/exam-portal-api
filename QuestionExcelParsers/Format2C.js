...
const formatID = new mongoose.Types.ObjectId('629b3acbc9756eb3b8d04092');

async function parseFormat2C(filepath, options = {}) {
    let dif = {};
    ...
    worksheet.eachRow(function (row, rowNumber) {
        if (rowNumber === 1) {
            ...
            if (!value[10])
                throw new InvalidFormatError(`${errPrefix}From unit not found '${value[10]}'`);
            if (!value[11])
