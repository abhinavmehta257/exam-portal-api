...
const formatID = new mongoose.Types.ObjectId('61bace9584476677d477e76b');

async function parseFormat1(filepath, options = {}) {
    let dif = {};
    ...
    worksheet.eachRow(function (row, rowNumber) {
        if (rowNumber === 1) {
            ...
            const answerPosition = parseInt(value[10], 10);
